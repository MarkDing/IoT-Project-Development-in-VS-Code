...
![arm_gnu_dir](./images/arm_gnu_dir.png)
...
![msys1_path](./images/msys1.0path.png)
...
![diff_template](./images/diff-template.png)
...
![cmdlinebuild](./images/cmdlinebuild.png)
...
![fail-goto-definition](./images/fail-goto-definition.png)
...
![c-conf-json](./images/C-conf-json.png)
...
![c_cpp_properties1](./images/c_cpp_properties1.png)
...
![includepath](./images/includepath.gif)

Remove some weird "../../" stuffs and final version looks like this

![final-include-path-json](./images/final-include-path-json.png)
...
![goto-definition](./images/goto-definition.png)
...
![build-task](./images/build-task.png)
...
![dropdown-build-task](./images/dropdown-build-task.png)

The output message can be seen in the bash terminal.

![build-output-message](./images/build-output-message.png)
